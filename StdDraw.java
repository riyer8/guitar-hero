...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    // default font
    private static final Font DEFAULT_FONT = new Font("San Sarif", Font.PLAIN, 16);
    ...
    private static JMenuBar createMenuBar() {
        ...
        JMenu menu = new JMenu("Made by Ramya Iyer and Jewell Jordan");
        menuBar.add(menu);
